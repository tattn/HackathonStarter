...
public enum Ionicons: String {
    ...
    static func font(size: CGFloat = UIFont.systemFontSize) -> UIFont {
        return UIFont(name: "ionicons", size: size) ?? UIFont.systemFont(ofSize: size)
    }

    func iconImage(size: CGFloat, color: UIColor = .white, backgroundColor: UIColor? = nil) -> UIImage {
        ...
        let font = type(of: self).font(size: size)
        ...
        let iconImage = UIGraphicsGetImageFromCurrentImageContext() ?? UIImage()
